...
#   FM_SERVER          SSH target (default: frappe@alok.rt.gw)
#   FM_BENCH           Bench/site name (default: fm.localhost)
#   FM_HOME            Home on remote (default: /home/frappe)
#   FM_PREVIOUS_REPO   Previous version spec (default: frappe-manager==0.18.0)
#   FM_REPO            Target version spec (default: git+https://...@fix-migrations)
#
...
FM_SERVER="${FM_SERVER:-frappe@alok.rt.gw}"
FM_BENCH="${FM_BENCH:-fm.localhost}"
FM_HOME="${FM_HOME:-/home/frappe}"
FM_PREVIOUS_REPO="${FM_PREVIOUS_REPO:-frappe-manager==0.18.0}"
FM_PREVIOUS_PYTHON="${FM_PREVIOUS_PYTHON:-3.12}"
